  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `books` (`id` TEXT NOT NULL, `title` TEXT, `authorId` TEXT, `genreId` TEXT, `description` TEXT, `coverUrl` TEXT, `fileUrl` TEXT, `rating` REAL, `ratingCount` INTEGER, PRIMARY KEY(`id`))");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'b42daf044f22cb9f687990ee6b725d73')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        _columnsBooks.put("authorId", new TableInfo.Column("authorId", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsBooks.put("genreId", new TableInfo.Column("genreId", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        _columnsBooks.put("fileUrl", new TableInfo.Column("fileUrl", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsBooks.put("rating", new TableInfo.Column("rating", "REAL", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsBooks.put("ratingCount", new TableInfo.Column("ratingCount", "INTEGER", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (!_infoBooks.equals(_existingBooks)) {
          return new RoomOpenHelper.ValidationResult(false, "books(com.electroniclibrary.data.room.BookEntity).\n"
                  + " Expected:\n" + _infoBooks + "\n"
                  + " Found:\n" + _existingBooks);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "b42daf044f22cb9f687990ee6b725d73", "b9daa780d8de4633192abbb6398aaf14");
